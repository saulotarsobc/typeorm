...
export class Entity1756175701979 implements MigrationInterface {
    name = 'Entity1756175701979'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "person" ADD CONSTRAINT "FK_person_user_id" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "person_address" ADD CONSTRAINT "FK_person_address_person_id" FOREIGN KEY ("person_id") REFERENCES "person"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "person" DROP CONSTRAINT "FK_person_user_id"`);
